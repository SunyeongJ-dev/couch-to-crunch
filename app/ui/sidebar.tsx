    ...
    <>
      ...
      <div className="sm:hidden fixed top-16 left-0 right-0 z-50 w-full border-b border-text-300 bg-sub-background px-6 py-3">
        <details className="group">
          ...
          <div className="relative z-50 overflow-y-auto no-scrollbar pt-4 pb-6 px-4 max-h-[calc(100vh-6rem)]">
            ...
            <button
              className="w-full text-sm text-white bg-accent hover:bg-accent-dark transition duration-300 px-3 py-1 rounded-md font-medium cursor-pointer"
              onClick={onReset}
            >
              Reset
            </button>
      ...
      >
        ...
        <div className="px-8">
          ...
          <button
            className={`${isCollapsed ? "hidden" : "block"} mt-2 text-sm text-white bg-accent hover:bg-accent-dark transition duration-300 px-3 py-1 rounded-md font-medium cursor-pointer`}
            onClick={onReset}
          >
            Reset
          </button>
